...
func NewServer(ctx context.Context, port int, certPath string, keyPath string, rootStorage string, actorSystem *actor.System, systemControl *system.DbusControl, diskMonitor *system.DiskMonitor, memoryMonitor system.MemoryMonitor) *Server {
